...
namespace BudgetScale.Application.Tests.Accounts
{
    ...
    public class AccountsCommandsTests : BudgetScaleTestBase
    {
        ...
        public async Task CreateAccount_WithAllPossibleAccountTypes_CreatesSuccessfullyAndSavesInDatabase(string accountName, string accountType, string userId)
        {   
            //Arrange
        ...
        [Test]
        [TestCase("1","A new account", "Cash")]
        [TestCase("2", "Weeknd", "Asset")]
    
        public async Task UpdateAccount_UpdatesTheCorrectAccountTest(string accountId,string accountName, string accountType)
        {
            //Arrange
